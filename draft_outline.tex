...
In United States, at a given point in time, young people are more supportive of government interventions to reduce inequality than older people. Figure 1 presents the results from four recent surveys: (i) our survey of 2025 survey of 2000 adults divided equally between people older and younger than 30, (ii) the survey from \cite{chinoy2026zero}, (iii) the most recent GSS survey (2021) -most recent, (iv) the most recent ANES survey.  All surveys indicate the presence of a strongly significant cross sectional  \textit{age gradient} - or equivalently \textit{generational gap}- in the intensity of support for redistribution. Older surveys similarly display such age gradient even if the steepness of the gradient has been evolving over time and is more pronounced in recent periods.

\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{graphs/fig1_age_gradient_recent.pdf}
    \caption{Age Gradient in Support or Redistribution}
    \label{fig:placeholder}
\end{figure}


This paper is the first who focuses specifically in documenting and  understanding this age gradient through a uniquely designed survey to test alternative explanations on why young people could have different pro-redistributive attitude. 

One trivial hypothesis is that young people are on average poorer than older individuals and thus would gain more from redistribution (the income hypothesis). A derived hypothesis young people view redistribution as a way to smooth income over the life cycle (the life-cycle hypothesis). An alternative hypothesis is that young people are faced with more dramatic risks looking going forward (e.g. climate risk, AI risk) and thus put more value of the redistribution induced safety net (the long run risk hypothesis). One other hypothesis is that they ignore what would be their future position in the income distribution, and therefore under a veil of ignorance, would like to hedge against the most adverse future income (the Rawlsian hypothesis). 

A second class of hypothesis would be that young people have different beliefs about the economic game they are playing into. An hypothesis suggested by the results of  \cite{chinoy2026zero} is that young people are more subject to zero-sum forms of thinking than older individuals. A companion hypothesis is that they view the society as offering less upward mobility opportunities. An alternative hypothesis is that they have different beliefs about the disincentive effect of redistributive taxation or the incentives benefits of large income. Finally one would like to test whether young people difference in the patience or in their inclination to give (to friends or to strangers) could correlate with their support with redistribution.

A robustness analysis reveals that zero-sum beliefs and the belief in the disincentive effect of redistribution are the only systematically robust and sizable determinants of differences in the support for redistribution. Income position, and future income risk play virtually no role and other explanation such as beliefs in social mobility or exposure to different risk play only a marginal role. Furthermore difference in zero-sum beliefs between young and old explain the majority of the difference in their support for redistribution. Other robust correlate such as the disincentive effect of redistribution taxation display no age gradient. Demographic variables play a modest role in explaining differences in zero-sum game mentality.   We confirm the main results of our survey with the information available from other survey. 

Using existing regularly ran surveys (GSS, ) we further establish than the age gradient has between young and old people have considerably widened over time. Figure 2. compared the GSS and ANES survey across. The gap has almost (doubled--tripled).  Finally we test some hypotheses regarding the increasing age polarization in attitude towards redistribution. We establish that widening gap in zero-sum game attitude explain a sizable proportion of the time evolution of the age gradient. We test some hypotheses regarding changes in zero-sum beliefs.

\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{graphs/pair_headline.pdf}
    \caption{Widening Age Gradient}
    \label{fig:placeholder}
\end{figure}
