...
\maketitle
\begin{abstract}
Young Americans hold markedly stronger preferences for redistribution than older Americans. Using a purpose-built survey balanced equally between adults younger and older than 30, we test a broad set of hypotheses for this age gap. Differences in zero-sum beliefs and in the perceived disincentive effects of progressive taxation account for the vast majority of the gap. We confirm these results in other cross-sectional and longitudinal surveys, and we document that the gap has widened considerably over time. We then investigate what could explain this widening.
\end{abstract}
