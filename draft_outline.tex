...
\maketitle
\begin{abstract}
Young Americans support redistribution far more strongly than older Americans, and this age gap has widened substantially over recent decades. Using a purpose-built survey of roughly 2{,}000 adults, balanced equally between those younger and older than 30, we test a broad range of explanations for the gap---economic self-interest, life-cycle and consumption-smoothing motives, exposure to long-run risks, and differences in beliefs, values, and time preferences. A robustness analysis isolates only two systematically robust and quantitatively large determinants: zero-sum beliefs about wealth and the belief that progressive taxation blunts incentives. Income and financial position, exposure to risk, and social-mobility beliefs play little role, and demographics account for only a modest share. Differences in zero-sum thinking alone explain the majority of the young--old gap. We replicate these patterns in independent cross-sectional and longitudinal surveys---the GSS, the ANES, and \citet{chinoy2026zero}---and show that the age gradient has steepened markedly since the 1980s, with the widening in zero-sum beliefs accounting for a sizable share of the trend. We conclude by examining what may have driven this change in beliefs.
\end{abstract}
...
In the United States, at any given point in time, young people are more supportive of government intervention to reduce inequality than older people are. Figure~\ref{fig:age-gradient} presents this pattern in four recent surveys: (i) our own 2025 survey of roughly 2{,}000 adults split equally between those younger and older than 30, (ii) the survey of \citet{chinoy2026zero}, (iii) the most recent wave of the General Social Survey (GSS, 2021), and (iv) the most recent wave of the American National Election Study (ANES, 2024). All four reveal a strongly significant cross-sectional \textit{age gradient}---equivalently, a \textit{generational gap}---in the intensity of support for redistribution. Earlier surveys display the same gradient, though its steepness has evolved over time and is most pronounced in recent years.
