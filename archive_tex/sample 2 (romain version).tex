...
Goal: explore and rule out competing hypotheses for why young people in the U.S. are more likely to support redistribution. \blue{The blue text describes how each question helps prove/rule out the hypothesis in its section.}

How to organize hypotheses

\begin{itemize}
    \item (a) Standard Preference and Difference in Risk
    \item (b)  Cross -Generational Difference in Preferences -- Leasures, Values
    \item (c) Difference in Beliefs
    \begin{itemize}
        \item Formative Years
        \item Generation
        \item Note: understand beliefs vs preference
    \end{itemize}
    \item (d) Behavioral Biases:
    \begin{itemize}
        \item  (a) Disposition effect 
        \item (b) myopic
    \end{itemize}
\item \end{itemize}

\begin{itemize}
    \item \textbf{Preference = f(consumption (+), labor(-), Values(+) 
    \item Difference in Belieds}
\end{itemize}
\begin{itemize}
    \item \textbf{Preference under uncertain income }
\end{itemize}
\begin{itemize}
    \item \textbf{undersranding: reversal in preference or in its value compoment}
\end{itemize}
\begin{itemize}
    \item \textbf{H1}\textbf{: Value of Insurance against Large Income/Status uncertainty}.  Young people are less certain about their future income/class, so they favor redistribution because of risk-aversion\textbf{ (Rawls being an extrem form min-max).} and \textbf{no savings.} 
    \item \textbf{H2}: \textbf{Preference to Leasure} Young people have different goals. They would rather live a balanced lifestyle than work long hours to get a prestigious job. This type of lifestyle--one where you can live well without working too hard and spend more time on activities outside your job--might be supported by redistribution. 
    \item \textbf{H3 Value Shift}Young people have different values. They might be more open to new experiences/concepts, which is associated with liberal voting. They may care more/less for others' wellbeing, or the wellbeing of others within their ``group.'' They may care more/less about freedom. They are less materialistic, so they don't care about how much they earn or how much the economy will grow. etc.
    \item \textbf{H4 Behavioral Bias  (i) Belief  formative experience}: Influenced by personal experience, the experience of their family, stories from previous generations, recent history in the U.S., or the media, young people have different economic beliefs. They have different conceptions of the ``incentive cost'' of redistribution. They believe that luck is a greater factor than hard work or that entrepreneurs will start new businesses even when their rewards are lower.
    \item \textbf{H5 Behaviorial Bias (ii) lack of experience on redistribution cost but still experience of its benefits}: Young people haven't experienced taxes yet, so they aren't able to accurately gauge how much it will hurt to be taxed (especially after working hard to earn their money and move up in their careers). Therefore, they are more likely to support taxation of high incomes. Similarly, young people may not have had bad experiences with the government yet, so they support more liberal policies. These are both forms of irrationality. \textbf{subjective well-being derive ex-post well being positive or negative }
    \item \textbf{H6 Belief difference - close to H3}: Young people support redistribution because they have a more favorable view of the lower class. As young people age, they get to know people who are lazy and squander their money on irresponsible purchases, which makes them less likely to support redistribution. This is related to ``incentive costs'', but it's not just the belief that welfare makes people lazy--it's the belief that these people don't deserve more money/resources, a sort of negative utility attached to their rewards.  \textbf{are people individually responsible for their povery-->Ester Dulot - Poor Economics --->}
    ...
    \begin{itemize}
        ...
        \item Young people are more ``idealistic'' and hopeful about how well progressive policies will work out. 
    \end{itemize}
\end{itemize}
...
\textbf{There is a experiment literature on testing for risk-aversion, loss avoidance, based on some lotteries}
\textbf{Uncertainty about Income Brackets} to \textbf{preference for redistribution}
\textbf{difference in risk-averion or difference in uncertainty}
...
\textbf{Here we can draw on Landier-Thesmar intervention}
...
\textbf{there is should a way to test for preference for labor}
...
\textbf{here we can use the vignette approach - are poor people responsible for being poor and see how people form different ages respond to vignette}
...
\section*{Hypothesis 6 (lack of prejudice)}
    ...
    \blue{It may be very possible to move up in society, but maybe there are some people that don't.}
    \Qitem{ \Qq{What percentage of people currently on welfare are not trying to get out of their current situation?}
    }
    \Qitem{ \Qq{Is it morally wrong to live off welfare?}
    }

\section*{Other questions}

\textbf{How do we test for the role of experience maybe the same game played by people from different generations }
